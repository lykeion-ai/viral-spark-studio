  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "highlight-hook": "hsl(var(--highlight-hook))",
        "highlight-body": "hsl(var(--highlight-body))",
        "highlight-outro": "hsl(var(--highlight-outro))",
        "highlight-image": "hsl(var(--highlight-image))",
